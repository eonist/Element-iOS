...
- Use .framework from the start (this will likely speed up build times) (research required) (Confirmed: splitting up in different frameworks helps with compile time artsy.com) [here](http://artsy.github.io/blog/2014/11/13/eidolon-retrospective/) 
